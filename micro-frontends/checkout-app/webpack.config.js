...
module.exports = {
  ...
  output: {
    ...
    publicPath: 'http://localhost:3005/', // Important for Module Federation
  },
  resolve: {
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'checkout_app',
      filename: 'remoteEntryCheckout.js',
      exposes: {
        './Checkout': './src/App', // Expose the App component
        './OrderSuccess': './src/pages/checkout/order.success.jsx', // Expose the App component
      },
      remotes: {
